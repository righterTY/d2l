...
def exposure_fusion(sequence, alphas=(1.0, 1.0, 1.0), best_illumination=0.5, sigma=0.2, eps=1e-12, use_lappyr=True, use_gaussi=False, layers_num=5, scale=2.0):
    """转化成 float 数据"""
